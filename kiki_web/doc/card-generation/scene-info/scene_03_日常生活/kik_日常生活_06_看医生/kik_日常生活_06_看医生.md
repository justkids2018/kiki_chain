...
- View: slightly elevated 3/4 top-front view, looking into a real 看医生 daily-life environment
...
Create a complete, real 看医生 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
1. 听诊器 (tīng zhěn qì / Stethoscope) — place naturally at a real-world position in this scene.
2. 体温计 (tǐ wēn jì / Thermometer) — place naturally at a real-world position in this scene.
3. 创可贴 (chuāng kě tiē / Band-Aid) — place naturally at a real-world position in this scene.
4. 药瓶 (yào píng / Medicine Bottle) — place naturally at a real-world position in this scene.
5. 注射器 (zhù shè qì / Syringe) — place naturally at a real-world position in this scene.
6. 白大褂 (bái dà guà / Lab Coat) — place naturally at a real-world position in this scene.
7. 口罩 (kǒu zhào / Mask) — place naturally at a real-world position in this scene.
8. 棉签 (mián qiān / Cotton Swab) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 听诊器 arrow -> lands on Stethoscope object body (not nearby blank/background).
- 体温计 arrow -> lands on Thermometer object body (not nearby blank/background).
- 创可贴 arrow -> lands on Band-Aid object body (not nearby blank/background).
- 药瓶 arrow -> lands on Medicine Bottle object body (not nearby blank/background).
- 注射器 arrow -> lands on Syringe object body (not nearby blank/background).
- 白大褂 arrow -> lands on Lab Coat object body (not nearby blank/background).
- 口罩 arrow -> lands on Mask object body (not nearby blank/background).
- 棉签 arrow -> lands on Cotton Swab object body (not nearby blank/background).
