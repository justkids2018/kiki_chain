...
> 分类：游乐场景
> 主题序号：4.1
> 场景文件：kik_游乐场景_01_恐龙世界.png
> 热区文件：kik_游乐场景_01_恐龙世界.json
...
### II. Scene Background
Create a complete 恐龙世界 adventure play environment inside a cozy Montessori-style play world.
The entire image IS this scene — there is no separate display table or product shelf.

Scene preset rules:
- Create a complete imaginative adventure play environment that clearly matches the current theme.
- The setting may be whimsical, but every target object must remain clear, tappable, and recognizable.
- Render fantasy and adventure elements as premium rounded toy-diorama props.
- Avoid dark, scary, chaotic, or realistic cinematic styling.

Theme-specific scene elements:
- A cheerful toy dinosaur adventure land with jungle and volcano anchors
- T-Rex and Triceratops separated with clear silhouettes
- Dinosaur egg, fossil, skeleton, footprint, volcano, and pterodactyl placed at different depths
- Keep dinosaurs cute and friendly, not scary
...
- whimsical but readable toy-diorama rendering
- clear visual hierarchy around 8 target objects

Scene atmosphere:
- Fun, imaginative, adventurous, sunny, cheerful, clearly navigable, and positive
- Color palette suggestion: 丛林绿、火山橙
...
- Outfit defaults to summer style, but can adapt naturally to the current adventure play scene.
...
- [bà wáng lóng] / 霸王龙 / T-Rex (/tiː rɛks/)
- [sān jiǎo lóng] / 三角龙 / Triceratops (/traɪˈsɛrətɑːps/)
- [yì lóng] / 翼龙 / Pterodactyl (/ˌtɛrəˈdæktɪl/)
- [kǒng lóng dàn] / 恐龙蛋 / Dinosaur Egg (/ˈdaɪnəsɔːr ɛɡ/)
- [huà shí] / 化石 / Fossil (/ˈfɑːsl/)
- [huǒ shān] / 火山 / Volcano (/vɑːlˈkeɪnoʊ/)
- [gǔ jià] / 骨架 / Skeleton (/ˈskɛlɪtn/)
- [jiǎo yìn] / 脚印 / Footprint (/ˈfʊtprɪnt/)

Object placement map:
1. 霸王龙 (bà wáng lóng / T-Rex) — place as a clear, separate, toy-like target object in a natural position for this scene.
2. 三角龙 (sān jiǎo lóng / Triceratops) — place as a clear, separate, toy-like target object in a natural position for this scene.
3. 翼龙 (yì lóng / Pterodactyl) — place as a clear, separate, toy-like target object in a natural position for this scene.
4. 恐龙蛋 (kǒng lóng dàn / Dinosaur Egg) — place as a clear, separate, toy-like target object in a natural position for this scene.
5. 化石 (huà shí / Fossil) — place as a clear, separate, toy-like target object in a natural position for this scene.
6. 火山 (huǒ shān / Volcano) — place as a clear, separate, toy-like target object in a natural position for this scene.
7. 骨架 (gǔ jià / Skeleton) — place as a clear, separate, toy-like target object in a natural position for this scene.
8. 脚印 (jiǎo yìn / Footprint) — place as a clear, separate, toy-like target object in a natural position for this scene.
...
- T-Rex and Triceratops must have clearly different silhouettes.
- Fossil and Skeleton must be separate objects.
- Footprint must be enlarged and readable on the ground.
- Volcano is a background anchor but still must be labeled clearly if target.
...
- [bà wáng lóng] / 霸王龙 / T-Rex
- [sān jiǎo lóng] / 三角龙 / Triceratops
- [yì lóng] / 翼龙 / Pterodactyl
- [kǒng lóng dàn] / 恐龙蛋 / Dinosaur Egg
- [huà shí] / 化石 / Fossil
- [huǒ shān] / 火山 / Volcano
- [gǔ jià] / 骨架 / Skeleton
...
Arrow precision map:
- 霸王龙 arrow -> lands on T-Rex object body.
- 三角龙 arrow -> lands on Triceratops object body.
- 翼龙 arrow -> lands on Pterodactyl object body.
- 恐龙蛋 arrow -> lands on Dinosaur Egg object body.
- 化石 arrow -> lands on Fossil object body.
- 火山 arrow -> lands on Volcano object body.
- 骨架 arrow -> lands on Skeleton object body.
- 脚印 arrow -> lands on Footprint object body.
...
- The scene must feel like a premium miniature toy diorama in an imaginative play setting, not a product display board and not a dark cinematic scene.
...
- [ ] 生成 PNG：`kik_游乐场景_01_恐龙世界.png`
- [ ] 生成 JSON：`kik_游乐场景_01_恐龙世界.json`
