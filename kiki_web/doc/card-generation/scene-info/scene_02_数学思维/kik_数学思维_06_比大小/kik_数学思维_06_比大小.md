...
> 分类：数学思维
> 主题序号：2.6
> 场景文件：kik_数学思维_06_比大小.png
> 热区文件：kik_数学思维_06_比大小.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 比大小 learning play environment
...
- Color palette suggestion: 对比色、鲜明暖色
...
Create a complete, real 比大小 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [dà xiàng] / 大象 / Elephant (/ˈɛlɪfənt/)
- [mǎ yǐ] / 蚂蚁 / Ant (/ænt/)
- [lán qiú] / 篮球 / Basketball (/ˈbæskɪtbɔːl/)
- [dàn zhū] / 弹珠 / Marble (/ˈmɑːrbl/)
- [xī guā] / 西瓜 / Watermelon (/ˈwɔːtərˌmɛlən/)
- [yīng táo] / 樱桃 / Cherry (/ˈtʃɛri/)
- [bā shì] / 巴士 / Bus (/bʌs/)
- [zì xíng chē] / 自行车 / Bicycle (/ˈbaɪsɪkl/)

Object placement map:
1. 大象 (dà xiàng / Elephant) — place naturally at a real-world position in this scene.
2. 蚂蚁 (mǎ yǐ / Ant) — place naturally at a real-world position in this scene.
3. 篮球 (lán qiú / Basketball) — place naturally at a real-world position in this scene.
4. 弹珠 (dàn zhū / Marble) — place naturally at a real-world position in this scene.
5. 西瓜 (xī guā / Watermelon) — place naturally at a real-world position in this scene.
6. 樱桃 (yīng táo / Cherry) — place naturally at a real-world position in this scene.
7. 巴士 (bā shì / Bus) — place naturally at a real-world position in this scene.
8. 自行车 (zì xíng chē / Bicycle) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 大象 arrow -> lands on Elephant object body (not nearby blank/background).
- 蚂蚁 arrow -> lands on Ant object body (not nearby blank/background).
- 篮球 arrow -> lands on Basketball object body (not nearby blank/background).
- 弹珠 arrow -> lands on Marble object body (not nearby blank/background).
- 西瓜 arrow -> lands on Watermelon object body (not nearby blank/background).
- 樱桃 arrow -> lands on Cherry object body (not nearby blank/background).
- 巴士 arrow -> lands on Bus object body (not nearby blank/background).
- 自行车 arrow -> lands on Bicycle object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_数学思维_06_比大小.png`
- [ ] 生成 JSON：`kik_数学思维_06_比大小.json`
