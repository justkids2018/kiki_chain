# 水果计数 — 真实场景学习卡片 Prompt

> 分类：数学思维
> 主题序号：2.3
> 场景文件：kik_数学思维_03_水果计数.png
> 热区文件：kik_数学思维_03_水果计数.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 水果计数 learning play environment
...
- Color palette suggestion: 水果色系、明亮暖色
...
Create a complete, real 水果计数 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [píng guǒ] / 苹果 / Apple (/ˈæpl/)
- [xiāng jiāo] / 香蕉 / Banana (/bəˈnænə/)
- [chéng zi] / 橙子 / Orange (/ˈɔːrɪndʒ/)
- [pú tao] / 葡萄 / Grape (/ɡreɪp/)
- [cǎo méi] / 草莓 / Strawberry (/ˈstrɔːberi/)
- [xī guā] / 西瓜 / Watermelon (/ˈwɔːtərˌmɛlən/)
- [táo zi] / 桃子 / Peach (/piːtʃ/)
- [lí] / 梨 / Pear (/pɛr/)

Object placement map:
1. 苹果 (píng guǒ / Apple) — place naturally at a real-world position in this scene.
2. 香蕉 (xiāng jiāo / Banana) — place naturally at a real-world position in this scene.
3. 橙子 (chéng zi / Orange) — place naturally at a real-world position in this scene.
4. 葡萄 (pú tao / Grape) — place naturally at a real-world position in this scene.
5. 草莓 (cǎo méi / Strawberry) — place naturally at a real-world position in this scene.
6. 西瓜 (xī guā / Watermelon) — place naturally at a real-world position in this scene.
7. 桃子 (táo zi / Peach) — place naturally at a real-world position in this scene.
8. 梨 (lí / Pear) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 苹果 arrow -> lands on Apple object body (not nearby blank/background).
- 香蕉 arrow -> lands on Banana object body (not nearby blank/background).
- 橙子 arrow -> lands on Orange object body (not nearby blank/background).
- 葡萄 arrow -> lands on Grape object body (not nearby blank/background).
- 草莓 arrow -> lands on Strawberry object body (not nearby blank/background).
- 西瓜 arrow -> lands on Watermelon object body (not nearby blank/background).
- 桃子 arrow -> lands on Peach object body (not nearby blank/background).
- 梨 arrow -> lands on Pear object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_数学思维_03_水果计数.png`
- [ ] 生成 JSON：`kik_数学思维_03_水果计数.json`
