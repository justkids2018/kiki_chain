# 配对游戏 — 真实场景学习卡片 Prompt

> 分类：数学思维
> 主题序号：2.5
> 场景文件：kik_数学思维_05_配对游戏.png
> 热区文件：kik_数学思维_05_配对游戏.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 配对游戏 learning play environment
...
- Color palette suggestion: 积木色、原木暖色
...
Create a complete, real 配对游戏 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [pīn tú] / 拼图 / Puzzle (/ˈpʌzl/)
- [jī mù] / 积木 / Blocks (/blɑːks/)
- [tóu zi] / 骰子 / Dice (/daɪs/)
- [kǎ piàn] / 卡片 / Card (/kɑːrd/)
- [qí pán] / 棋盘 / Board (/bɔːrd/)
- [qí zi] / 棋子 / Chess Piece (/tʃɛs piːs/)
- [shā chuí] / 沙锤 / Maracas (/məˈrɑːkəz/)
- [qī qiǎo bǎn] / 七巧板 / Tangram (/ˈtæŋɡræm/)

Object placement map:
1. 拼图 (pīn tú / Puzzle) — place naturally at a real-world position in this scene.
2. 积木 (jī mù / Blocks) — place naturally at a real-world position in this scene.
3. 骰子 (tóu zi / Dice) — place naturally at a real-world position in this scene.
4. 卡片 (kǎ piàn / Card) — place naturally at a real-world position in this scene.
5. 棋盘 (qí pán / Board) — place naturally at a real-world position in this scene.
6. 棋子 (qí zi / Chess Piece) — place naturally at a real-world position in this scene.
7. 沙锤 (shā chuí / Maracas) — place naturally at a real-world position in this scene.
8. 七巧板 (qī qiǎo bǎn / Tangram) — place naturally at a real-world position in this scene.
...
- [kǎ piàn] / 卡片 / Card
- [qí pán] / 棋盘 / Board
- [qí zi] / 棋子 / Chess Piece
- [shā chuí] / 沙锤 / Maracas
- [qī qiǎo bǎn] / 七巧板 / Tangram
...
Arrow precision map:
- 拼图 arrow -> lands on Puzzle object body (not nearby blank/background).
- 积木 arrow -> lands on Blocks object body (not nearby blank/background).
- 骰子 arrow -> lands on Dice object body (not nearby blank/background).
- 卡片 arrow -> lands on Card object body (not nearby blank/background).
- 棋盘 arrow -> lands on Board object body (not nearby blank/background).
- 棋子 arrow -> lands on Chess Piece object body (not nearby blank/background).
- 沙锤 arrow -> lands on Maracas object body (not nearby blank/background).
- 七巧板 arrow -> lands on Tangram object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_数学思维_05_配对游戏.png`
- [ ] 生成 JSON：`kik_数学思维_05_配对游戏.json`
