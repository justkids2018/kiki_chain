...
- View: slightly elevated 3/4 top-front view, looking into a real 沙滩乐园 adventure environment
...
Create a complete, real 沙滩乐园 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
Scene atmosphere:
- Fun, imaginative, and clearly navigable
...
1. 沙桶 (shā tǒng / Sand Bucket) — place naturally at a real-world position in this scene.
2. 铲子 (chǎn zi / Shovel) — place naturally at a real-world position in this scene.
3. 贝壳 (bèi ké / Shell) — place naturally at a real-world position in this scene.
4. 海星 (hǎi xīng / Starfish) — place naturally at a real-world position in this scene.
5. 遮阳伞 (zhē yáng sǎn / Beach Umbrella) — place naturally at a real-world position in this scene.
6. 冲浪板 (chōng làng bǎn / Surfboard) — place naturally at a real-world position in this scene.
7. 泳圈 (yǒng quān / Swim Ring) — place naturally at a real-world position in this scene.
8. 椰子树 (yē zi shù / Palm Tree) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 沙桶 arrow -> lands on Sand Bucket object body (not nearby blank/background).
- 铲子 arrow -> lands on Shovel object body (not nearby blank/background).
- 贝壳 arrow -> lands on Shell object body (not nearby blank/background).
- 海星 arrow -> lands on Starfish object body (not nearby blank/background).
- 遮阳伞 arrow -> lands on Beach Umbrella object body (not nearby blank/background).
- 冲浪板 arrow -> lands on Surfboard object body (not nearby blank/background).
- 泳圈 arrow -> lands on Swim Ring object body (not nearby blank/background).
- 椰子树 arrow -> lands on Palm Tree object body (not nearby blank/background).
