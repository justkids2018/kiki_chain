...
- View: slightly elevated 3/4 top-front view, looking into a real 童话城堡 adventure environment
...
Create a complete, real 童话城堡 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
1. 城堡 (chéng bǎo / Castle) — place naturally at a real-world position in this scene.
2. 王冠 (wáng guān / Crown) — place naturally at a real-world position in this scene.
3. 魔法棒 (mó fǎ bàng / Magic Wand) — place naturally at a real-world position in this scene.
4. 龙 (lóng / Dragon) — place naturally at a real-world position in this scene.
5. 公主 (gōng zhǔ / Princess) — place naturally at a real-world position in this scene.
6. 骑士 (qí shì / Knight) — place naturally at a real-world position in this scene.
7. 盾牌 (dùn pái / Shield) — place naturally at a real-world position in this scene.
8. 宝剑 (bǎo jiàn / Sword) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 城堡 arrow -> lands on Castle object body (not nearby blank/background).
- 王冠 arrow -> lands on Crown object body (not nearby blank/background).
- 魔法棒 arrow -> lands on Magic Wand object body (not nearby blank/background).
- 龙 arrow -> lands on Dragon object body (not nearby blank/background).
- 公主 arrow -> lands on Princess object body (not nearby blank/background).
- 骑士 arrow -> lands on Knight object body (not nearby blank/background).
- 盾牌 arrow -> lands on Shield object body (not nearby blank/background).
- 宝剑 arrow -> lands on Sword object body (not nearby blank/background).
