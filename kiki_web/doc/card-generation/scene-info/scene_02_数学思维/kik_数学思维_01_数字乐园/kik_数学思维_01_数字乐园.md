# 数字乐园 — 真实场景学习卡片 Prompt

> 分类：数学思维
> 主题序号：2.1
> 场景文件：kik_数学思维_01_数字乐园.png
> 热区文件：kik_数学思维_01_数字乐园.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 数字乐园 learning play environment
...
- Color palette suggestion: 彩虹渐变、明亮色
...
Create a complete, real 数字乐园 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [ ] 生成 PNG：`kik_数学思维_01_数字乐园.png`
- [ ] 生成 JSON：`kik_数学思维_01_数字乐园.json`
