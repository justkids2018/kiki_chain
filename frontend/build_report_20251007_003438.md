...
- **镜像大小**: 121MB
- **导出文件**: frontend/qiqimanyou-flutter-web-amd64-20251007_003438.tar.gz
- **文件大小**:  43M
- **Flutter 构建大小**: 
...
└── build_report_20251007_003438.md            # 本构建报告
```
...
## 📞 技术支持
- 构建日志: build_20251007_003438.log
- Flutter 版本: Flutter 3.29.2
- 构建时间: 2025-10-07 00:35:45
