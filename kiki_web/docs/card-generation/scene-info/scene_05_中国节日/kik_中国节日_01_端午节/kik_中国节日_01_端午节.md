...
> 分类：中国节日
> 主题序号：5.1
> 场景文件：kik_中国节日_01_端午节.png
> 热区文件：kik_中国节日_01_端午节.json
...
### II. Scene Background
Create a complete 端午节 family celebration environment inside a cozy Montessori-style play world.
The entire image IS this scene — there is no separate display table or product shelf.

Scene preset rules:
- Create a warm, festive Dragon Boat Festival home / courtyard environment that clearly matches Chinese Duanwu tradition.
- Keep the cultural symbols readable: zongzi, dragon boat, mugwort, sachet, five-color string.
...
- A cozy traditional Chinese family room or courtyard celebrating Dragon Boat Festival
- Bamboo-leaf-wrapped zongzi piled in a steamer or plate as the largest foreground hero
- A small toy dragon boat with carved dragon head placed at middle ground
- Bunches of green mugwort hanging by the doorway
- Colorful embroidered sachet (xiangbao) hanging or held by a sister
...
- Character outfits may include traditional Chinese touches (盘扣外套、改良汉服、节日围裙) but stay child-friendly and modern-comfortable.
...
- [zòng zi] / 粽子 / Zongzi (/ˈzɔŋziː/)
- [lóng zhōu] / 龙舟 / Dragon Boat (/ˈdræɡən boʊt/)
- [ài cǎo] / 艾草 / Mugwort (/ˈmʌɡwɜːrt/)
- [xiāng bāo] / 香包 / Sachet (/sæˈʃeɪ/)
...
2. 龙舟 (lóng zhōu / Dragon Boat) — small carved toy dragon boat at middle ground on a low table or shelf.
3. 艾草 (ài cǎo / Mugwort) — bundle of green mugwort hanging by the doorway or wall.
4. 香包 (xiāng bāo / Sachet) — colorful embroidered sachet hanging from a string or held in younger sister's hand.
...
Arrow precision map:
- 粽子 arrow -> lands on the zongzi pile body.
- 龙舟 arrow -> lands on the dragon boat body.
- 艾草 arrow -> lands on the mugwort bundle.
- 香包 arrow -> lands on the embroidered sachet body.
...
- The scene must feel like a premium miniature toy diorama in a warm Chinese festival home setting, not a product display board and not a dark cinematic scene.
...
- [ ] 生成 PNG：`kik_中国节日_01_端午节.png`
- [ ] 生成 JSON：`kik_中国节日_01_端午节.json`
