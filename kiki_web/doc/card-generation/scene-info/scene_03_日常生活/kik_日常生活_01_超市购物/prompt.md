...
- View: slightly elevated 3/4 top-front view, looking into a real 超市购物 daily-life environment
...
- Color palette suggestion: 明亮白、浅蓝色
...
Create a complete, real 超市购物 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [shōu yín tái] / 收银台 / Cashier (/kæˈʃɪr/)
- [huò jià] / 货架 / Shelf (/ʃɛlf/)
- [jià gé biāo qiān] / 价格标签 / Price Tag (/praɪs tæɡ/)
- [gòu wù dài] / 购物袋 / Shopping Bag (/ˈʃɑːpɪŋ bæɡ/)
- [líng shí] / 零食 / Snack (/snæk/)
- [yǐn liào] / 饮料 / Drink (/drɪŋk/)
- [táng guǒ] / 糖果 / Candy (/ˈkændi/)

Object placement map:
1. 购物车 (gòu wù chē / Shopping Cart) — place naturally at a real-world position in this scene.
2. 收银台 (shōu yín tái / Cashier) — place naturally at a real-world position in this scene.
3. 货架 (huò jià / Shelf) — place naturally at a real-world position in this scene.
4. 价格标签 (jià gé biāo qiān / Price Tag) — place naturally at a real-world position in this scene.
5. 购物袋 (gòu wù dài / Shopping Bag) — place naturally at a real-world position in this scene.
6. 零食 (líng shí / Snack) — place naturally at a real-world position in this scene.
7. 饮料 (yǐn liào / Drink) — place naturally at a real-world position in this scene.
8. 糖果 (táng guǒ / Candy) — place naturally at a real-world position in this scene.
...
- [gòu wù chē] / 购物车 / Shopping Cart
- [shōu yín tái] / 收银台 / Cashier
- [huò jià] / 货架 / Shelf
- [jià gé biāo qiān] / 价格标签 / Price Tag
- [gòu wù dài] / 购物袋 / Shopping Bag
- [líng shí] / 零食 / Snack
- [yǐn liào] / 饮料 / Drink
- [táng guǒ] / 糖果 / Candy
...
Arrow precision map:
- 购物车 arrow -> lands on Shopping Cart object body (not nearby blank/background).
- 收银台 arrow -> lands on Cashier object body (not nearby blank/background).
- 货架 arrow -> lands on Shelf object body (not nearby blank/background).
- 价格标签 arrow -> lands on Price Tag object body (not nearby blank/background).
- 购物袋 arrow -> lands on Shopping Bag object body (not nearby blank/background).
- 零食 arrow -> lands on Snack object body (not nearby blank/background).
- 饮料 arrow -> lands on Drink object body (not nearby blank/background).
- 糖果 arrow -> lands on Candy object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_日常生活_01_超市购物.png`
- [ ] 生成 JSON：`kik_日常生活_01_超市购物.json`
