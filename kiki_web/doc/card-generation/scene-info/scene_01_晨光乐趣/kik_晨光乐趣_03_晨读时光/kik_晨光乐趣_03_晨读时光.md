# 晨读时光 — 真实场景学习卡片 Prompt

> 分类：晨光乐趣
> 主题序号：1.3
> 场景文件：kik_晨光乐趣_03_晨读时光.png
> 热区文件：kik_晨光乐趣_03_晨读时光.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 晨读时光 school environment
...
- Color palette suggestion: 暖木色、米白色
...
Create a complete, real 晨读时光 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [kè běn] / 课本 / Textbook (/ˈtɛkstbʊk/)
- [shū bāo] / 书包 / School Bag (/skuːl bæɡ/)
- [hēi bǎn] / 黑板 / Blackboard (/ˈblækbɔːrd/)
- [fěn bǐ] / 粉笔 / Chalk (/tʃɔːk/)
- [jiǎng tái] / 讲台 / Podium (/ˈpoʊdiəm/)
- [kè zhuō] / 课桌 / Desk (/dɛsk/)
- [shū qiān] / 书签 / Bookmark (/ˈbʊkmɑːrk/)
- [yǎn jìng] / 眼镜 / Glasses (/ˈɡlæsɪz/)

Object placement map:
1. 课本 (kè běn / Textbook) — place naturally at a real-world position in this scene.
2. 书包 (shū bāo / School Bag) — place naturally at a real-world position in this scene.
3. 黑板 (hēi bǎn / Blackboard) — place naturally at a real-world position in this scene.
4. 粉笔 (fěn bǐ / Chalk) — place naturally at a real-world position in this scene.
5. 讲台 (jiǎng tái / Podium) — place naturally at a real-world position in this scene.
6. 课桌 (kè zhuō / Desk) — place naturally at a real-world position in this scene.
7. 书签 (shū qiān / Bookmark) — place naturally at a real-world position in this scene.
8. 眼镜 (yǎn jìng / Glasses) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 课本 arrow -> lands on Textbook object body (not nearby blank/background).
- 书包 arrow -> lands on School Bag object body (not nearby blank/background).
- 黑板 arrow -> lands on Blackboard object body (not nearby blank/background).
- 粉笔 arrow -> lands on Chalk object body (not nearby blank/background).
- 讲台 arrow -> lands on Podium object body (not nearby blank/background).
- 课桌 arrow -> lands on Desk object body (not nearby blank/background).
- 书签 arrow -> lands on Bookmark object body (not nearby blank/background).
- 眼镜 arrow -> lands on Glasses object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_03_晨读时光.png`
- [ ] 生成 JSON：`kik_晨光乐趣_03_晨读时光.json`
