...
- View: slightly elevated 3/4 top-front view, looking into a real 恐龙世界 adventure environment
...
Create a complete, real 恐龙世界 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
1. 霸王龙 (bà wáng lóng / T-Rex) — place naturally at a real-world position in this scene.
2. 三角龙 (sān jiǎo lóng / Triceratops) — place naturally at a real-world position in this scene.
3. 翼龙 (yì lóng / Pterodactyl) — place naturally at a real-world position in this scene.
4. 恐龙蛋 (kǒng lóng dàn / Dinosaur Egg) — place naturally at a real-world position in this scene.
5. 化石 (huà shí / Fossil) — place naturally at a real-world position in this scene.
6. 火山 (huǒ shān / Volcano) — place naturally at a real-world position in this scene.
7. 骨架 (gǔ jià / Skeleton) — place naturally at a real-world position in this scene.
8. 脚印 (jiǎo yìn / Footprint) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 霸王龙 arrow -> lands on T-Rex object body (not nearby blank/background).
- 三角龙 arrow -> lands on Triceratops object body (not nearby blank/background).
- 翼龙 arrow -> lands on Pterodactyl object body (not nearby blank/background).
- 恐龙蛋 arrow -> lands on Dinosaur Egg object body (not nearby blank/background).
- 化石 arrow -> lands on Fossil object body (not nearby blank/background).
- 火山 arrow -> lands on Volcano object body (not nearby blank/background).
- 骨架 arrow -> lands on Skeleton object body (not nearby blank/background).
- 脚印 arrow -> lands on Footprint object body (not nearby blank/background).
