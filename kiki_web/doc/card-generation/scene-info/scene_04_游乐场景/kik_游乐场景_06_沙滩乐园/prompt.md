...
> 分类：游乐场景
> 主题序号：4.6
> 场景文件：kik_游乐场景_06_沙滩乐园.png
> 热区文件：kik_游乐场景_06_沙滩乐园.json
...
### II. Scene Background
Create a complete 沙滩乐园 adventure play environment inside a cozy Montessori-style play world.
...
- A sunny toy beach play scene with sand, sea, and play props
- Sandcastle, beach ball, umbrella, bucket, shovel, shell, sunglasses, and surfboard separated clearly
- Use beach gold and ocean blue with bright clean sunlight
- Keep sand and water as background, not competing target objects
...
- Color palette suggestion: 沙滩金、海洋蓝
...
- [shā tǒng] / 沙桶 / Sand Bucket (/sænd ˈbʌkɪt/)
- [chǎn zi] / 铲子 / Shovel (/ˈʃʌvl/)
- [bèi ké] / 贝壳 / Shell (/ʃɛl/)
- [hǎi xīng] / 海星 / Starfish (/ˈstɑːrfɪʃ/)
- [zhē yáng sǎn] / 遮阳伞 / Beach Umbrella (/biːtʃ ʌmˈbrɛlə/)
- [chōng làng bǎn] / 冲浪板 / Surfboard (/ˈsɜːrfbɔːrd/)
- [yǒng quān] / 泳圈 / Swim Ring (/swɪm rɪŋ/)
- [yē zi shù] / 椰子树 / Palm Tree (/pɑːm triː/)

Object placement map:
1. 沙桶 (shā tǒng / Sand Bucket) — place as a clear, separate, toy-like target object in a natural position for this scene.
2. 铲子 (chǎn zi / Shovel) — place as a clear, separate, toy-like target object in a natural position for this scene.
3. 贝壳 (bèi ké / Shell) — place as a clear, separate, toy-like target object in a natural position for this scene.
4. 海星 (hǎi xīng / Starfish) — place as a clear, separate, toy-like target object in a natural position for this scene.
5. 遮阳伞 (zhē yáng sǎn / Beach Umbrella) — place as a clear, separate, toy-like target object in a natural position for this scene.
6. 冲浪板 (chōng làng bǎn / Surfboard) — place as a clear, separate, toy-like target object in a natural position for this scene.
7. 泳圈 (yǒng quān / Swim Ring) — place as a clear, separate, toy-like target object in a natural position for this scene.
8. 椰子树 (yē zi shù / Palm Tree) — place as a clear, separate, toy-like target object in a natural position for this scene.
...
- Bucket and shovel must be separate.
- Shell and sunglasses must not overlap.
- Beach ball and umbrella must be distinct round/canopy shapes.
- Surfboard must be clearly separate from sand or water background.
...
- [shā tǒng] / 沙桶 / Sand Bucket
- [chǎn zi] / 铲子 / Shovel
- [bèi ké] / 贝壳 / Shell
- [hǎi xīng] / 海星 / Starfish
- [zhē yáng sǎn] / 遮阳伞 / Beach Umbrella
- [chōng làng bǎn] / 冲浪板 / Surfboard
- [yǒng quān] / 泳圈 / Swim Ring
- [yē zi shù] / 椰子树 / Palm Tree
...
Arrow precision map:
- 沙桶 arrow -> lands on Sand Bucket object body.
- 铲子 arrow -> lands on Shovel object body.
- 贝壳 arrow -> lands on Shell object body.
- 海星 arrow -> lands on Starfish object body.
- 遮阳伞 arrow -> lands on Beach Umbrella object body.
- 冲浪板 arrow -> lands on Surfboard object body.
- 泳圈 arrow -> lands on Swim Ring object body.
- 椰子树 arrow -> lands on Palm Tree object body.
...
- [ ] 生成 PNG：`kik_游乐场景_06_沙滩乐园.png`
- [ ] 生成 JSON：`kik_游乐场景_06_沙滩乐园.json`
