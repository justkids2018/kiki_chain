...
- View: slightly elevated 3/4 top-front view, looking into a real 太空探险 adventure environment
...
Create a complete, real 太空探险 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
1. 火箭 (huǒ jiàn / Rocket) — place naturally at a real-world position in this scene.
2. 宇航员 (yǔ háng yuán / Astronaut) — place naturally at a real-world position in this scene.
3. 月球 (yuè qiú / Moon) — place naturally at a real-world position in this scene.
4. 星星 (xīng xīng / Star) — place naturally at a real-world position in this scene.
5. 飞碟 (fēi dié / UFO) — place naturally at a real-world position in this scene.
6. 望远镜 (wàng yuǎn jìng / Telescope) — place naturally at a real-world position in this scene.
7. 太阳 (tài yáng / Sun) — place naturally at a real-world position in this scene.
8. 地球 (dì qiú / Earth) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 火箭 arrow -> lands on Rocket object body (not nearby blank/background).
- 宇航员 arrow -> lands on Astronaut object body (not nearby blank/background).
- 月球 arrow -> lands on Moon object body (not nearby blank/background).
- 星星 arrow -> lands on Star object body (not nearby blank/background).
- 飞碟 arrow -> lands on UFO object body (not nearby blank/background).
- 望远镜 arrow -> lands on Telescope object body (not nearby blank/background).
- 太阳 arrow -> lands on Sun object body (not nearby blank/background).
- 地球 arrow -> lands on Earth object body (not nearby blank/background).
