...
2. 肥皂 (féi zào / Soap) — place as a clear, separate, toy-like target object in a natural position for this scene.
3. 毛巾 (máo jīn / Towel) — place as a clear, separate, toy-like target object in a natural position for this scene.
4. 洗发水 (xǐ fà shuǐ / Shampoo) — place as a clear, separate, toy-like target object in a natural position for this scene.
5. 泡泡 (pào pào / Bubble) — place as a clear, separate, toy-like target object in a natural position for this scene.
6. 小黄鸭 (xiǎo huáng yā / Rubber Duck) — place as a clear, separate, toy-like target object in a natural position for this scene.
7. 花洒 (huā sǎ / Shower) — place as a clear, separate, toy-like target object in a natural position for this scene.
8. 浴帽 (yù mào / Shower Cap) — place as a clear, separate, toy-like target object in a natural position for this scene.
...
- 肥皂 arrow -> lands on Soap object body.
- 毛巾 arrow -> lands on Towel object body.
- 洗发水 arrow -> lands on Shampoo object body.
- 泡泡 arrow -> lands on Bubble object body.
- 小黄鸭 arrow -> lands on Rubber Duck object body.
- 花洒 arrow -> lands on Shower object body.
- 浴帽 arrow -> lands on Shower Cap object body.
...
- [ ] 生成 PNG：`kik_日常生活_04_洗澡时间.png`
- [ ] 生成 JSON：`kik_日常生活_04_洗澡时间.json`
