...
> 分类：数学思维
> 主题序号：2.4
> 场景文件：kik_数学思维_04_量一量.png
> 热区文件：kik_数学思维_04_量一量.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 量一量 learning play environment
...
- Color palette suggestion: 科学蓝、白色
...
Create a complete, real 量一量 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
Scene atmosphere:
- Explorative, playful, and structured cognition space
...
- [chǐ zi] / 尺子 / Ruler (/ˈruːlər/)
- [tiān píng] / 天平 / Balance (/ˈbæləns/)
- [shā lòu] / 沙漏 / Hourglass (/ˈaʊərˌɡlæs/)
- [wēn dù jì] / 温度计 / Thermometer (/θərˈmɑːmɪtər/)
- [liáng bēi] / 量杯 / Measuring Cup (/ˈmɛʒərɪŋ kʌp/)
- [chèng] / 秤 / Scale (/skeɪl/)
- [shí zhōng] / 时钟 / Clock (/klɑːk/)
- [jì suàn qì] / 计算器 / Calculator (/ˈkælkjəˌleɪtər/)

Object placement map:
1. 尺子 (chǐ zi / Ruler) — place naturally at a real-world position in this scene.
2. 天平 (tiān píng / Balance) — place naturally at a real-world position in this scene.
3. 沙漏 (shā lòu / Hourglass) — place naturally at a real-world position in this scene.
4. 温度计 (wēn dù jì / Thermometer) — place naturally at a real-world position in this scene.
5. 量杯 (liáng bēi / Measuring Cup) — place naturally at a real-world position in this scene.
6. 秤 (chèng / Scale) — place naturally at a real-world position in this scene.
7. 时钟 (shí zhōng / Clock) — place naturally at a real-world position in this scene.
8. 计算器 (jì suàn qì / Calculator) — place naturally at a real-world position in this scene.
...
- [chǐ zi] / 尺子 / Ruler
- [tiān píng] / 天平 / Balance
- [shā lòu] / 沙漏 / Hourglass
- [wēn dù jì] / 温度计 / Thermometer
- [liáng bēi] / 量杯 / Measuring Cup
- [chèng] / 秤 / Scale
- [shí zhōng] / 时钟 / Clock
- [jì suàn qì] / 计算器 / Calculator
...
Arrow precision map:
- 尺子 arrow -> lands on Ruler object body (not nearby blank/background).
- 天平 arrow -> lands on Balance object body (not nearby blank/background).
- 沙漏 arrow -> lands on Hourglass object body (not nearby blank/background).
- 温度计 arrow -> lands on Thermometer object body (not nearby blank/background).
- 量杯 arrow -> lands on Measuring Cup object body (not nearby blank/background).
- 秤 arrow -> lands on Scale object body (not nearby blank/background).
- 时钟 arrow -> lands on Clock object body (not nearby blank/background).
- 计算器 arrow -> lands on Calculator object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_数学思维_04_量一量.png`
- [ ] 生成 JSON：`kik_数学思维_04_量一量.json`
