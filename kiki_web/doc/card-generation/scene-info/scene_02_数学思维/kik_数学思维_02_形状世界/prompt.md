# 形状世界 — 真实场景学习卡片 Prompt

> 分类：数学思维
> 主题序号：2.2
> 场景文件：kik_数学思维_02_形状世界.png
> 热区文件：kik_数学思维_02_形状世界.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 形状世界 learning play environment
...
- Color palette suggestion: 几何蓝、明亮黄
...
Create a complete, real 形状世界 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [sān jiǎo xíng] / 三角形 / Triangle (/ˈtraɪæŋɡl/)
- [cháng fāng xíng] / 长方形 / Rectangle (/ˈrɛktæŋɡl/)
- [xīng xíng] / 星形 / Star (/stɑːr/)
- [xīn xíng] / 心形 / Heart (/hɑːrt/)
- [líng xíng] / 菱形 / Diamond (/ˈdaɪəmənd/)
- [tuǒ yuán xíng] / 椭圆形 / Oval (/ˈoʊvəl/)

Object placement map:
1. 圆形 (yuán xíng / Circle) — place naturally at a real-world position in this scene.
2. 正方形 (zhèng fāng xíng / Square) — place naturally at a real-world position in this scene.
3. 三角形 (sān jiǎo xíng / Triangle) — place naturally at a real-world position in this scene.
4. 长方形 (cháng fāng xíng / Rectangle) — place naturally at a real-world position in this scene.
5. 星形 (xīng xíng / Star) — place naturally at a real-world position in this scene.
6. 心形 (xīn xíng / Heart) — place naturally at a real-world position in this scene.
7. 菱形 (líng xíng / Diamond) — place naturally at a real-world position in this scene.
8. 椭圆形 (tuǒ yuán xíng / Oval) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 圆形 arrow -> lands on Circle object body (not nearby blank/background).
- 正方形 arrow -> lands on Square object body (not nearby blank/background).
- 三角形 arrow -> lands on Triangle object body (not nearby blank/background).
- 长方形 arrow -> lands on Rectangle object body (not nearby blank/background).
- 星形 arrow -> lands on Star object body (not nearby blank/background).
- 心形 arrow -> lands on Heart object body (not nearby blank/background).
- 菱形 arrow -> lands on Diamond object body (not nearby blank/background).
- 椭圆形 arrow -> lands on Oval object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_数学思维_02_形状世界.png`
- [ ] 生成 JSON：`kik_数学思维_02_形状世界.json`
