# 校园花园 — 真实场景学习卡片 Prompt

> 分类：晨光乐趣
> 主题序号：1.6
> 场景文件：kik_晨光乐趣_06_校园花园.png
> 热区文件：kik_晨光乐趣_06_校园花园.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 校园花园 school environment
...
- Color palette suggestion: 嫩绿色、花瓣粉
...
Create a complete, real 校园花园 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [huā duǒ] / 花朵 / Flower (/ˈflaʊər/)
- [hú dié] / 蝴蝶 / Butterfly (/ˈbʌtərflaɪ/)
- [mì fēng] / 蜜蜂 / Bee (/biː/)
- [shuǐ hú] / 水壶 / Watering Can (/ˈwɔːtərɪŋ kæn/)
- [zhǒng zi] / 种子 / Seed (/siːd/)
- [ní tǔ] / 泥土 / Soil (/sɔɪl/)
- [xiǎo chǎn zi] / 小铲子 / Trowel (/ˈtraʊəl/)
- [piáo chóng] / 瓢虫 / Ladybug (/ˈleɪdibʌɡ/)

Object placement map:
1. 花朵 (huā duǒ / Flower) — place naturally at a real-world position in this scene.
2. 蝴蝶 (hú dié / Butterfly) — place naturally at a real-world position in this scene.
3. 蜜蜂 (mì fēng / Bee) — place naturally at a real-world position in this scene.
4. 水壶 (shuǐ hú / Watering Can) — place naturally at a real-world position in this scene.
5. 种子 (zhǒng zi / Seed) — place naturally at a real-world position in this scene.
6. 泥土 (ní tǔ / Soil) — place naturally at a real-world position in this scene.
7. 小铲子 (xiǎo chǎn zi / Trowel) — place naturally at a real-world position in this scene.
8. 瓢虫 (piáo chóng / Ladybug) — place naturally at a real-world position in this scene.
...
- [hú dié] / 蝴蝶 / Butterfly
- [mì fēng] / 蜜蜂 / Bee
- [shuǐ hú] / 水壶 / Watering Can
- [zhǒng zi] / 种子 / Seed
- [ní tǔ] / 泥土 / Soil
- [xiǎo chǎn zi] / 小铲子 / Trowel
- [piáo chóng] / 瓢虫 / Ladybug
...
Arrow precision map:
- 花朵 arrow -> lands on Flower object body (not nearby blank/background).
- 蝴蝶 arrow -> lands on Butterfly object body (not nearby blank/background).
- 蜜蜂 arrow -> lands on Bee object body (not nearby blank/background).
- 水壶 arrow -> lands on Watering Can object body (not nearby blank/background).
- 种子 arrow -> lands on Seed object body (not nearby blank/background).
- 泥土 arrow -> lands on Soil object body (not nearby blank/background).
- 小铲子 arrow -> lands on Trowel object body (not nearby blank/background).
- 瓢虫 arrow -> lands on Ladybug object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_06_校园花园.png`
- [ ] 生成 JSON：`kik_晨光乐趣_06_校园花园.json`
