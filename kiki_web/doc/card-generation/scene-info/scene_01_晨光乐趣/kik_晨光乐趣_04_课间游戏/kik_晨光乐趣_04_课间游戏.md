# 课间游戏 — 真实场景学习卡片 Prompt

> 分类：晨光乐趣
> 主题序号：1.4
> 场景文件：kik_晨光乐趣_04_课间游戏.png
> 热区文件：kik_晨光乐趣_04_课间游戏.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 课间游戏 school environment
...
- [huā shéng] / 花绳 / String Game (/strɪŋ ɡeɪm/)
- [gé zi] / 格子 / Hopscotch Grid (/ˈhɑːpskɑːtʃ ɡrɪd/)
- [shí tou] / 石头 / Rock (/rɑːk/)
- [tuó luó] / 陀螺 / Spinning Top (/ˈspɪnɪŋ tɑːp/)
- [bù] / 布 / Cloth (/klɔːθ/)
- [xiàng pí jīn] / 橡皮筋 / Rubber Band (/ˈrʌbər bænd/)

Object placement map:
1. 弹珠 (dàn zhū / Marble) — place naturally at a real-world position in this scene.
2. 纸飞机 (zhǐ fēi jī / Paper Plane) — place naturally at a real-world position in this scene.
3. 花绳 (huā shéng / String Game) — place naturally at a real-world position in this scene.
4. 格子 (gé zi / Hopscotch Grid) — place naturally at a real-world position in this scene.
5. 石头 (shí tou / Rock) — place naturally at a real-world position in this scene.
6. 陀螺 (tuó luó / Spinning Top) — place naturally at a real-world position in this scene.
7. 布 (bù / Cloth) — place naturally at a real-world position in this scene.
...
- [dàn zhū] / 弹珠 / Marble
- [zhǐ fēi jī] / 纸飞机 / Paper Plane
- [huā shéng] / 花绳 / String Game
- [gé zi] / 格子 / Hopscotch Grid
- [shí tou] / 石头 / Rock
- [tuó luó] / 陀螺 / Spinning Top
- [bù] / 布 / Cloth
- [xiàng pí jīn] / 橡皮筋 / Rubber Band
...
- 纸飞机 arrow -> lands on Paper Plane object body (not nearby blank/background).
- 花绳 arrow -> lands on String Game object body (not nearby blank/background).
- 格子 arrow -> lands on Hopscotch Grid object body (not nearby blank/background).
- 石头 arrow -> lands on Rock object body (not nearby blank/background).
- 陀螺 arrow -> lands on Spinning Top object body (not nearby blank/background).
- 布 arrow -> lands on Cloth object body (not nearby blank/background).
- 橡皮筋 arrow -> lands on Rubber Band object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_04_课间游戏.png`
- [ ] 生成 JSON：`kik_晨光乐趣_04_课间游戏.json`
