...
> 分类：中国节日
> 主题序号：5.4
> 场景文件：kik_中国节日_04_冬至.png
> 热区文件：kik_中国节日_04_冬至.json
...
### II. Scene Background
Create a complete 冬至 winter family-warmth environment inside a cozy Montessori-style play world.
...
- A cozy traditional family kitchen / dining area celebrating Winter Solstice
- A plate of freshly steamed dumplings (jiaozi) in classic crescent shape as foreground hero
- A bowl of round white tangyuan in sweet soup with sesame steam
- A soft knitted scarf draped on the back of a chair
...
- theme-matching immersive Chinese winter festival scene
...
Scene atmosphere:
- Warm, cozy, family-loving, peaceful, soft, clearly navigable, and positive
- Color palette suggestion: 暖灰白、雪青、姜黄（饺子皮色）、暖木棕
- Subtle depth-of-field: center sharper, far edges slightly softer
- Soft warm indoor light against soft cool snow light from the window
...
- Character outfits adapted to winter: knitted sweater, soft padded jacket, scarf, warm leggings, soft boots; may include subtle Chinese touches (盘扣外套).
...
- [tāng yuán] / 汤圆 / Tangyuan (/ˈtɑːŋˈjwɛn/)
...
1. 饺子 (jiǎo zi / Dumpling) — plate of freshly steamed crescent dumplings as foreground hero, with light steam.
2. 汤圆 (tāng yuán / Tangyuan) — bowl of round white tangyuan in sweet soup, ideally with a small spoon nearby.
3. 围巾 (wéi jīn / Scarf) — soft knitted scarf draped on the back of a chair or hanging on a hook.
...
- 汤圆 arrow -> lands on the tangyuan bowl body.
...
- The scene must feel like a premium miniature toy diorama in a cozy winter solstice home, not a product display board and not a dark cinematic scene.
...
- [ ] 生成 PNG：`kik_中国节日_04_冬至.png`
- [ ] 生成 JSON：`kik_中国节日_04_冬至.json`
