...
> 分类：游乐场景
> 主题序号：4.4
> 场景文件：kik_游乐场景_04_童话城堡.png
> 热区文件：kik_游乐场景_04_童话城堡.json
...
### II. Scene Background
Create a complete 童话城堡 adventure play environment inside a cozy Montessori-style play world.
...
- A toy fairy-tale castle scene with bright magical playroom atmosphere
- Castle, crown, magic wand, carriage, dragon, princess dress, bridge, and tower separated clearly
- Use dreamy purple and gold while keeping all objects readable
- Keep dragon cute and friendly, not threatening
...
- Color palette suggestion: 梦幻紫、金色
...
- [chéng bǎo] / 城堡 / Castle (/ˈkæsl/)
- [wáng guān] / 王冠 / Crown (/kraʊn/)
- [mó fǎ bàng] / 魔法棒 / Magic Wand (/ˈmædʒɪk wɑːnd/)
- [lóng] / 龙 / Dragon (/ˈdræɡən/)
- [gōng zhǔ] / 公主 / Princess (/ˈprɪnsɛs/)
- [qí shì] / 骑士 / Knight (/naɪt/)
- [dùn pái] / 盾牌 / Shield (/ʃiːld/)
- [bǎo jiàn] / 宝剑 / Sword (/sɔːrd/)

Object placement map:
1. 城堡 (chéng bǎo / Castle) — place as a clear, separate, toy-like target object in a natural position for this scene.
2. 王冠 (wáng guān / Crown) — place as a clear, separate, toy-like target object in a natural position for this scene.
3. 魔法棒 (mó fǎ bàng / Magic Wand) — place as a clear, separate, toy-like target object in a natural position for this scene.
4. 龙 (lóng / Dragon) — place as a clear, separate, toy-like target object in a natural position for this scene.
5. 公主 (gōng zhǔ / Princess) — place as a clear, separate, toy-like target object in a natural position for this scene.
6. 骑士 (qí shì / Knight) — place as a clear, separate, toy-like target object in a natural position for this scene.
7. 盾牌 (dùn pái / Shield) — place as a clear, separate, toy-like target object in a natural position for this scene.
8. 宝剑 (bǎo jiàn / Sword) — place as a clear, separate, toy-like target object in a natural position for this scene.
...
- Castle and tower must be visually distinct if both appear.
- Crown and magic wand must be separated.
- Carriage and bridge must not overlap.
- Dragon must be cute and clearly separate from castle background.
...
Arrow precision map:
- 城堡 arrow -> lands on Castle object body.
- 王冠 arrow -> lands on Crown object body.
- 魔法棒 arrow -> lands on Magic Wand object body.
- 龙 arrow -> lands on Dragon object body.
- 公主 arrow -> lands on Princess object body.
- 骑士 arrow -> lands on Knight object body.
- 盾牌 arrow -> lands on Shield object body.
- 宝剑 arrow -> lands on Sword object body.
...
- [ ] 生成 PNG：`kik_游乐场景_04_童话城堡.png`
- [ ] 生成 JSON：`kik_游乐场景_04_童话城堡.json`
