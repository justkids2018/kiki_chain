...
3. **获得新星星**：  
   ...
   - 动画效果：运行曲线采用前段加速飞出、后段减速落地的动感轨迹，整体耗时约 850ms，且飞出时自带轻微放大。
   - 到达目标位置后，该星星点亮（金色实心，无发散光晕）。
   - 星星落地时按顺序播放一次短鼓励语：“加油哟”、“你真棒”、“恭喜你完成”。
...
| 音效 | 文件 | 触发时机 |
|------|------|----------|
| 第 1 颗星 | `assets/audio/star_1.mp3` | 星星点亮时播放“加油哟” |
| 第 2 颗星 | `assets/audio/star_2.mp3` | 星星点亮时播放“你真棒” |
| 第 3 颗星 | `assets/audio/star_3_complete.mp3` | 星星点亮时播放“恭喜你完成” |
