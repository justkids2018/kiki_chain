...
- View: slightly elevated 3/4 top-front view, looking into a real 穿衣搭配 daily-life environment
...
Create a complete, real 穿衣搭配 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
1. 上衣 (shàng yī / Shirt) — place naturally at a real-world position in this scene.
2. 裤子 (kù zi / Pants) — place naturally at a real-world position in this scene.
3. 裙子 (qún zi / Skirt) — place naturally at a real-world position in this scene.
4. 袜子 (wà zi / Socks) — place naturally at a real-world position in this scene.
5. 帽子 (mào zi / Hat) — place naturally at a real-world position in this scene.
6. 围巾 (wéi jīn / Scarf) — place naturally at a real-world position in this scene.
7. 手套 (shǒu tào / Gloves) — place naturally at a real-world position in this scene.
8. 运动鞋 (yùn dòng xié / Sneakers) — place naturally at a real-world position in this scene.
...
Arrow precision map:
- 上衣 arrow -> lands on Shirt object body (not nearby blank/background).
- 裤子 arrow -> lands on Pants object body (not nearby blank/background).
- 裙子 arrow -> lands on Skirt object body (not nearby blank/background).
- 袜子 arrow -> lands on Socks object body (not nearby blank/background).
- 帽子 arrow -> lands on Hat object body (not nearby blank/background).
- 围巾 arrow -> lands on Scarf object body (not nearby blank/background).
- 手套 arrow -> lands on Gloves object body (not nearby blank/background).
- 运动鞋 arrow -> lands on Sneakers object body (not nearby blank/background).
