# 升旗仪式 — 真实场景学习卡片 Prompt

> 分类：晨光乐趣
> 主题序号：1.2
> 场景文件：kik_晨光乐趣_02_升旗仪式.png
> 热区文件：kik_晨光乐趣_02_升旗仪式.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 升旗仪式 school environment
...
- Color palette suggestion: 红色、金色、天蓝
...
Create a complete, real 升旗仪式 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
Scene atmosphere:
- Warm, focused, lively morning campus feeling
...
- [guó qí] / 国旗 / National Flag (/ˈnæʃənəl flæɡ/)
- [qí gān] / 旗杆 / Flagpole (/ˈflæɡpoʊl/)
- [hóng lǐng jīn] / 红领巾 / Red Scarf (/rɛd skɑːrf/)
- [gǔ] / 鼓 / Drum (/drʌm/)
- [xiào huī] / 校徽 / School Badge (/skuːl bædʒ/)
- [huà tǒng] / 话筒 / Microphone (/ˈmaɪkrəfoʊn/)
- [lǎ bā] / 喇叭 / Loudspeaker (/ˈlaʊdspiːkər/)
- [jiǎng zhuàng] / 奖状 / Certificate (/sərˈtɪfɪkɪt/)

Object placement map:
1. 国旗 (guó qí / National Flag) — place naturally at a real-world position in this scene.
2. 旗杆 (qí gān / Flagpole) — place naturally at a real-world position in this scene.
3. 红领巾 (hóng lǐng jīn / Red Scarf) — place naturally at a real-world position in this scene.
4. 鼓 (gǔ / Drum) — place naturally at a real-world position in this scene.
5. 校徽 (xiào huī / School Badge) — place naturally at a real-world position in this scene.
6. 话筒 (huà tǒng / Microphone) — place naturally at a real-world position in this scene.
7. 喇叭 (lǎ bā / Loudspeaker) — place naturally at a real-world position in this scene.
8. 奖状 (jiǎng zhuàng / Certificate) — place naturally at a real-world position in this scene.
...
- [guó qí] / 国旗 / National Flag
- [qí gān] / 旗杆 / Flagpole
- [hóng lǐng jīn] / 红领巾 / Red Scarf
- [gǔ] / 鼓 / Drum
- [xiào huī] / 校徽 / School Badge
- [huà tǒng] / 话筒 / Microphone
- [lǎ bā] / 喇叭 / Loudspeaker
- [jiǎng zhuàng] / 奖状 / Certificate
...
Arrow precision map:
- 国旗 arrow -> lands on National Flag object body (not nearby blank/background).
- 旗杆 arrow -> lands on Flagpole object body (not nearby blank/background).
- 红领巾 arrow -> lands on Red Scarf object body (not nearby blank/background).
- 鼓 arrow -> lands on Drum object body (not nearby blank/background).
- 校徽 arrow -> lands on School Badge object body (not nearby blank/background).
- 话筒 arrow -> lands on Microphone object body (not nearby blank/background).
- 喇叭 arrow -> lands on Loudspeaker object body (not nearby blank/background).
- 奖状 arrow -> lands on Certificate object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_02_升旗仪式.png`
- [ ] 生成 JSON：`kik_晨光乐趣_02_升旗仪式.json`
