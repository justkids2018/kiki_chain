...
> 分类：晨光乐趣
> 主题序号：1.8
> 场景文件：kik_晨光乐趣_08_图书角.png
> 热区文件：kik_晨光乐趣_08_图书角.json
...
### II. Scene Background
Create a complete classroom reading-corner environment inside a cozy Montessori-style play world.
The entire image IS this scene — there is no separate display table or product shelf.

Scene preset rules:
- Create a soft, cozy reading nook in a corner of the classroom: a small carpet area with a low bookshelf, soft lighting, and reading accessories.
- Keep reading items readable and toy-cute: picture book, bookshelf, cushion, carpet, table lamp, bookmark, sticker, small poster.
- Render every object as a premium rounded toy-diorama item.

Theme-specific scene elements:
- A small low bookshelf with a few colorful picture books standing up (background anchor)
- One opened picture book lying on the carpet as foreground hero
- A round soft cushion / pouf for sitting on the carpet
- A soft round carpet/rug covering the corner floor
- A small warm-white table lamp on a tiny side table
- A bookmark with a tassel sticking out of one of the books
- A sheet of cute reward stickers on the table or carpet edge
- A small colorful "Reading is Fun" toy-style poster on the wall

General scene elements:
- theme-matching immersive school scene
...
Scene atmosphere:
- Warm, calm, cozy, focused, clearly navigable, and positive
- Color palette suggestion: 奶油白、暖木色、薄荷绿、淡粉、柔黄
- Subtle depth-of-field: center sharper, far edges slightly softer
- Soft warm reading-lamp glow
- No giant title text anywhere

Depth distribution:
- Foreground: 2-3 large and clear target objects (opened picture book, cushion, carpet)
- Middle ground: main character action and 3-4 target objects (table lamp, bookmark, sticker sheet)
- Background: theme anchors, room anchors, and remaining objects (bookshelf, poster)
...
- Character outfits: cozy reading-corner look (soft cardigan, cute dress, knit top).
...
- [huì běn] / 绘本 / Picture Book (/ˈpɪktʃər bʊk/)
- [shū jià] / 书架 / Bookshelf (/ˈbʊkʃɛlf/)
...
1. 绘本 (huì běn / Picture Book) — opened picture book lying on the carpet, foreground hero with visible cute illustration on its pages.
2. 书架 (shū jià / Bookshelf) — small low bookshelf with several colorful picture books standing up, background anchor.
...
- Every label card must copy one exact vocabulary row from section IV: [pinyin] / hanzi / english.
...
- If any label, arrow, or emphasized target object is not in section IV, the image fails and must be regenerated.
...
- [huì běn] / 绘本 / Picture Book
- [shū jià] / 书架 / Bookshelf
- [bào zhěn] / 抱枕 / Cushion
- [dì tǎn] / 地毯 / Carpet
...
Arrow precision map:
- 绘本 arrow -> lands on the opened picture book pages.
- 书架 arrow -> lands on the bookshelf body.
...
- The scene must feel like a premium miniature toy reading corner, not a real-library photo.
...
- [ ] 生成 PNG：`kik_晨光乐趣_08_图书角.png`
- [ ] 生成 JSON：`kik_晨光乐趣_08_图书角.json`
