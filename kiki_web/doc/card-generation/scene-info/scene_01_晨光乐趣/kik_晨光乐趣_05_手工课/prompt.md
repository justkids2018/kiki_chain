...
> 分类：晨光乐趣
> 主题序号：1.5
> 场景文件：kik_晨光乐趣_05_手工课.png
> 热区文件：kik_晨光乐趣_05_手工课.json
...
- View: slightly elevated 3/4 top-front view, looking into a real 手工课 school environment
...
- Color palette suggestion: 彩虹色、马卡龙色
...
Create a complete, real 手工课 environment. The entire image IS this scene — there is no separate display table or product shelf.
...
- [jiǎn dāo] / 剪刀 / Scissors (/ˈsɪzərz/)
- [jiāo shuǐ] / 胶水 / Glue (/ɡluː/)
- [cǎi zhǐ] / 彩纸 / Colored Paper (/ˈkʌlərd ˈpeɪpər/)
- [huà bǐ] / 画笔 / Paintbrush (/ˈpeɪntbrʌʃ/)
- [yán liào] / 颜料 / Paint (/peɪnt/)
- [tiáo sè pán] / 调色盘 / Palette (/ˈpælɪt/)
- [xiàng pí ní] / 橡皮泥 / Clay (/kleɪ/)
- [qiān zhǐ hè] / 千纸鹤 / Paper Crane (/ˈpeɪpər kreɪn/)

Object placement map:
1. 剪刀 (jiǎn dāo / Scissors) — place naturally at a real-world position in this scene.
2. 胶水 (jiāo shuǐ / Glue) — place naturally at a real-world position in this scene.
3. 彩纸 (cǎi zhǐ / Colored Paper) — place naturally at a real-world position in this scene.
4. 画笔 (huà bǐ / Paintbrush) — place naturally at a real-world position in this scene.
5. 颜料 (yán liào / Paint) — place naturally at a real-world position in this scene.
6. 调色盘 (tiáo sè pán / Palette) — place naturally at a real-world position in this scene.
7. 橡皮泥 (xiàng pí ní / Clay) — place naturally at a real-world position in this scene.
8. 千纸鹤 (qiān zhǐ hè / Paper Crane) — place naturally at a real-world position in this scene.
...
- [jiǎn dāo] / 剪刀 / Scissors
- [jiāo shuǐ] / 胶水 / Glue
- [cǎi zhǐ] / 彩纸 / Colored Paper
- [huà bǐ] / 画笔 / Paintbrush
- [yán liào] / 颜料 / Paint
- [tiáo sè pán] / 调色盘 / Palette
- [xiàng pí ní] / 橡皮泥 / Clay
- [qiān zhǐ hè] / 千纸鹤 / Paper Crane
...
Arrow precision map:
- 剪刀 arrow -> lands on Scissors object body (not nearby blank/background).
- 胶水 arrow -> lands on Glue object body (not nearby blank/background).
- 彩纸 arrow -> lands on Colored Paper object body (not nearby blank/background).
- 画笔 arrow -> lands on Paintbrush object body (not nearby blank/background).
- 颜料 arrow -> lands on Paint object body (not nearby blank/background).
- 调色盘 arrow -> lands on Palette object body (not nearby blank/background).
- 橡皮泥 arrow -> lands on Clay object body (not nearby blank/background).
- 千纸鹤 arrow -> lands on Paper Crane object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_05_手工课.png`
- [ ] 生成 JSON：`kik_晨光乐趣_05_手工课.json`
