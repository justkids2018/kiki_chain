...
> 分类：游乐场景
> 主题序号：4.2
> 场景文件：kik_游乐场景_02_太空探险.png
> 热区文件：kik_游乐场景_02_太空探险.json
...
### II. Scene Background
Create a complete 太空探险 adventure play environment inside a cozy Montessori-style play world.
...
- A toy space exploration playroom with moon surface, stars, planets, and rocket props
- Rocket, astronaut, moon, star, UFO, telescope, sun, and earth placed in separate zones
- Use bright starry blue and purple without making labels dark
- Keep all space objects rounded, friendly, and child-safe
...
- Color palette suggestion: 深紫色、星空蓝
...
- [huǒ jiàn] / 火箭 / Rocket (/ˈrɑːkɪt/)
- [yǔ háng yuán] / 宇航员 / Astronaut (/ˈæstrənɔːt/)
- [yuè qiú] / 月球 / Moon (/muːn/)
- [xīng xīng] / 星星 / Star (/stɑːr/)
- [fēi dié] / 飞碟 / UFO (/juː ɛf oʊ/)
- [wàng yuǎn jìng] / 望远镜 / Telescope (/ˈtɛlɪskoʊp/)
- [tài yáng] / 太阳 / Sun (/sʌn/)
- [dì qiú] / 地球 / Earth (/ɜːrθ/)

Object placement map:
1. 火箭 (huǒ jiàn / Rocket) — place as a clear, separate, toy-like target object in a natural position for this scene.
2. 宇航员 (yǔ háng yuán / Astronaut) — place as a clear, separate, toy-like target object in a natural position for this scene.
3. 月球 (yuè qiú / Moon) — place as a clear, separate, toy-like target object in a natural position for this scene.
4. 星星 (xīng xīng / Star) — place as a clear, separate, toy-like target object in a natural position for this scene.
5. 飞碟 (fēi dié / UFO) — place as a clear, separate, toy-like target object in a natural position for this scene.
6. 望远镜 (wàng yuǎn jìng / Telescope) — place as a clear, separate, toy-like target object in a natural position for this scene.
7. 太阳 (tài yáng / Sun) — place as a clear, separate, toy-like target object in a natural position for this scene.
8. 地球 (dì qiú / Earth) — place as a clear, separate, toy-like target object in a natural position for this scene.
...
- Moon, Sun, and Earth must be distinct round objects.
- Star must be a clear star shape, not just a background star field.
- UFO and Rocket must not overlap.
- Telescope must be a ground/room prop, not a label-like shape.
...
Arrow precision map:
- 火箭 arrow -> lands on Rocket object body.
- 宇航员 arrow -> lands on Astronaut object body.
- 月球 arrow -> lands on Moon object body.
- 星星 arrow -> lands on Star object body.
- 飞碟 arrow -> lands on UFO object body.
- 望远镜 arrow -> lands on Telescope object body.
- 太阳 arrow -> lands on Sun object body.
- 地球 arrow -> lands on Earth object body.
...
- [ ] 生成 PNG：`kik_游乐场景_02_太空探险.png`
- [ ] 生成 JSON：`kik_游乐场景_02_太空探险.json`
