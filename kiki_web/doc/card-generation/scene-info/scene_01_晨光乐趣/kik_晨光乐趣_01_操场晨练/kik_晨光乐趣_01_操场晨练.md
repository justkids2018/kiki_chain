# 操场晨练 — 真实场景学习卡片 Prompt

> 分类：晨光乐趣
> 主题序号：1.1
> 场景文件：kik_晨光乐趣_01_操场晨练.png
> 热区文件：kik_晨光乐趣_01_操场晨练.json
...
- View: slightly elevated 3/4 top-front view, looking into a real outdoor school playground morning exercise environment
...
Scene atmosphere:
- Warm, lively, and clearly outdoor school exercise scene
...
- [pí qiú] / 皮球 / Ball (/bɔːl/)
- [hū lā quān] / 呼啦圈 / Hula Hoop (/ˈhuːlə huːp/)
- [pǎo dào] / 跑道 / Track (/træk/)
- [shào zi] / 哨子 / Whistle (/ˈwɪsl/)
- [cāo chǎng] / 操场 / Playground (/ˈpleɪɡraʊnd/)
- [jiàn zi] / 毽子 / Shuttlecock (/ˈʃʌtlkɑːk/)
- [shā bāo] / 沙包 / Sandbag (/ˈsændbæɡ/)
...
- [tiào shéng] / 跳绳 / Jump Rope
- [pí qiú] / 皮球 / Ball
- [hū lā quān] / 呼啦圈 / Hula Hoop
- [pǎo dào] / 跑道 / Track
- [shào zi] / 哨子 / Whistle
- [cāo chǎng] / 操场 / Playground
- [jiàn zi] / 毽子 / Shuttlecock
- [shā bāo] / 沙包 / Sandbag
...
- The arrow should land on the most recognizable body part of the target object, never on a nearby similar shape.
- Avoid crossing and ambiguous endpoints
- All arrows should share one consistent accent color family

Arrow precision map:
- 跳绳 arrow -> lands on Jump Rope object body (not nearby blank/background).
- 皮球 arrow -> lands on Ball object body (not nearby blank/background).
- 呼啦圈 arrow -> lands on Hula Hoop object body (not nearby blank/background).
- 跑道 arrow -> lands on Track object body (not nearby blank/background).
- 哨子 arrow -> lands on Whistle object body (not nearby blank/background).
- 操场 arrow -> lands on Playground object body (not nearby blank/background).
- 毽子 arrow -> lands on Shuttlecock object body (not nearby blank/background).
- 沙包 arrow -> lands on Sandbag object body (not nearby blank/background).
...
- [ ] 生成 PNG：`kik_晨光乐趣_01_操场晨练.png`
- [ ] 生成 JSON：`kik_晨光乐趣_01_操场晨练.json`
